...
const HELP = `
${pc.bold("astrostack")} — install AstroStack components into your Astro project.

${pc.bold("Usage")}
  astrostack <command> [options]
...
${pc.bold("Options")}
  ...
  -f, --force       Overwrite existing files instead of writing *.astrostack-new
  -h, --help        Show help
  -v, --version     Show version

${pc.bold("Examples")}
  ${pc.dim("$")} astrostack list
  ${pc.dim("$")} astrostack add auth
  ${pc.dim("$")} astrostack add auth --cwd ./my-site
`;
